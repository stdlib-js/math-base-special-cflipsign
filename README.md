...
```javascript
import cflipsign from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-cflipsign@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-cflipsign/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/math-base-special-cflipsign/actions/workflows/test.yml?query=branch:v0.1.0
